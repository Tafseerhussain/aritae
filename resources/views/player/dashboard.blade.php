    ...
    <div class="dashboard-base">
        @if (Auth::user()->player->cover_img == '')
            <div class="cover-img">
                ...
                <a href="{{ route('player.profile') }}" class="btn btn-theme">
                    Upload Cover Photo
                </a>
            </div>
        @else
            <div class="cover-img cover-img-added" style="background: url({{ asset(Auth::user()->player->cover_img) }}) no-repeat;">
            </div>
        @endif
                ...
                <div class="col-md-7">
                    <div class="left">
                        <div class="d-flex">
                            ...
                            @else
                                <img src="{{ asset(Auth::user()->player->profile_img) }}" class="shadow" alt="">
                            @endif
        ...
        <div class="row">
            <div class="col-md-7">
                <div class="profile-info">
                    <div class="card">
                        <a href="{{ route('player.profile') }}" class="icon" data-bs-toggle="tooltip" data-bs-title="Edit Information">
                            <i class="fa-regular fa-pen-to-square"></i>
                        </a>
                        <h5>Profile Information</h5>
                        <p>
                            @if (Auth::user()->player->about == '')
                                ---
                            @else
                                {{ Auth::user()->player->about }}
                            @endif
                        </p>
                        <p>
                        ...
                        <p>
                            ...
                            @if (Auth::user()->player->phone == '')
                                ---
                            @else
                                {{ Auth::user()->player->phone }}
                            @endif
                        </p>
                        <p>
