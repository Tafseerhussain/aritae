                    ...
                    <div class="sidebar">
                        ...
                        <div class="sidebar-links">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item {{ $route == 'player.all_sessions' ? 'active' : '' }}">
                                    <a href="{{ route('player.all_sessions') }}">
                                        <i class="bi bi-stopwatch"></i>
                                        <span>Sessions</span>
                                    </a>
                                </li>
                                <li class="list-group-item {{ $route == 'player.teams' ? 'active' : '' }}">
                                    <a href="{{ route('player.teams') }}">
                                ...
                                <li class="list-group-item {{ $route == 'player.team_requests' ? 'active' : '' }}">
                                    <a href="{{ route('player.team_requests') }}">
                                        <i class="bi bi-people"></i>
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end bg-light user-action-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        @else
                                            <div class="d-flex justify-content-start align-items-center">
                                                @if(auth()->user()->player->profile_img)
                                                    <img class="profile-image" src="{{asset(auth()->user()->player->profile_img)}}" onerror="this.src='{{asset('assets/img/default/default-profile-pic.jpg')}}'" alt="Profile Photo">
                                                @else
                                                ...
                                                <div>
                                                    ...
                                                    <span class="text-secondary profile-focus">{{auth()->user()->area_of_focus}} Player</span>
                                                </div>
                                            </div>
                                            <hr class="dropdown-divider">
                                            <a class="dropdown-item text-dark" href="{{ route('player.dashboard') }}">
                                            ...
                                            <a class="dropdown-item text-dark" href="{{ route('player.profile') }}">
                                                <i class="bi bi-person-fill icon"></i> {{__('My Profile')}}
                                            </a>
                                            <a class="dropdown-item text-dark" href="{{ route('player.settings') }}">
