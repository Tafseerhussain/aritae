                ...
                <div class="col-md-2 sidebar-col">
                    <div class="sidebar">
                        ...
                        <div class="sidebar-links">
                            <ul class="list-group">
                                <li class="list-group-item {{ $route == 'parent.dashboard' ? 'active' : '' }}">
                                    <a href="{{ route('parent.dashboard') }}">
                                        <i class="bi bi-boxes"></i> <span>Dashboard</span>
                                    </a>
                                </li>
                                <li class="list-group-item drop-menu {{ $route == 'parent.profile' ? 'active' : '' }}">
                                    <div class="accordion" id="accordionPanelsStayOpenExample">
                                      <div class="accordion-item">
                                        <div class="accordion-header" id="panelsStayOpen-headingThree">
                                        @if ($route == 'parent.profile')
                                            <button 
                                        ...
                                        <div id="panelsStayOpen-profile" 
                                          ...
                                          <div class="accordion-body">
                                            <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                                                <li>
                                                    <a href="{{ route('parent.profile') }}" class="link-dark rounded">
                                ...
                                <li class="list-group-item {{ $route == 'parent.player' ? 'active' : '' }}">
                                    <a href="{{ route('parent.player') }}">
                                        <i class="bi bi-people"></i> <span>Player</span>
                                    </a>
                                </li>
                                <li class="list-group-item {{ $route == 'parent.chat' ? 'active' : '' }}">
                                    <a href="{{ route('parent.chat') }}">
                                        ...
                                        @else
                                            <div class="d-flex justify-content-start align-items-center">
                                                @if(auth()->user()->parent->profile_img)
                                                    <img class="profile-image" src="{{asset(auth()->user()->parent->profile_img)}}" onerror="this.src='{{asset('assets/img/default/default-profile-pic.jpg')}}'" alt="Profile Photo">
                                                @else
                                                ...
                                                <div>
                                                    ...
                                                    <span class="text-secondary profile-focus">Parent Account</span>
                                                </div>
                                            </div>
                                            <hr class="dropdown-divider">
                                            <a class="dropdown-item text-dark" href="{{ route('parent.dashboard') }}">
                                            ...
                                            <a class="dropdown-item text-dark" href="{{ route('parent.profile') }}">
                                                <i class="bi bi-person-fill icon"></i> {{__('My Profile')}}
                                            </a>
                                            <a class="dropdown-item text-dark" href="{{ route('parent.settings') }}">
