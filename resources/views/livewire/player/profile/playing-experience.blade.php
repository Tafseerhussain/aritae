    ...
    <div class="toast-container position-fixed bottom-0 end-0 p-3">
        <div class="toast d-block border-0" role="alert" aria-live="assertive" aria-atomic="true">
          <div class="toast-header text-white bg-success">
            ...
            <strong class="me-auto">Playing Experience</strong>
        ...
        <form wire:submit.prevent="submit">
            <div class="row">
                ...
                <div class="col-lg-6 mb-3">
                    ...
                    <input id="teamName" type="text" class="form-control @error('teamName') is-invalid @enderror" placeholder="Example team" wire:model.defer="teamName">
                    @error('teamName')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
