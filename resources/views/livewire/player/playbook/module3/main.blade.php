<div>
    <div class="row form-completion-progress align-items-end">
        <div class="col-md-6">
            <h5 class="text-primary font-oswald text-uppercase m-0">Module # 3</h5>
        </div>
        <div class="col-md-6">
    ...
    @if($playsheet == 1)
        @livewire('player.playbook.module3.playsheet1', ['playbook_id' => $playbook_id])
    @elseif($playsheet == 2)
        @livewire('player.playbook.module3.playsheet2', ['playbook_id' => $playbook_id])
    @endif
</div>
