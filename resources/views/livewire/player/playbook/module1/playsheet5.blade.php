        ...
        <div class="card p-md-4 p-3 position-relative">
            ...
            <div class="card-head text-center">
                <div class="head text-uppercase font-oswald text-primary">
                    ...
                    <h4>VALUES & CONVICTIONS</h4>
                </div>
                <p>
                    Your personal values and beliefs are the basis for your daily decisions and actions. Below, list the things you care about. Examples might be showing respect for others, being a good friend, putting your family first, etc.
                </p>
            </div>
