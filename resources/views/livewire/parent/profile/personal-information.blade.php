    ...
    <div class="card-head">
        ...
        <div class="d-flex profile-meta-bar justify-content-between">
            ...
            {{--<div class="profile-completion text-end">
                    <small>Your Profile is {{$profileScore}}% complete</small>
                <div class="progress">
                    <div class="progress-bar" role="progressbar" aria-label="Example with label" style="width: {{$profileScore}}%;" aria-valuenow="{{$profileScore}}" aria-valuemin="0" aria-valuemax="100">{{$profileScore}}%</div>
                </div>
            </div>--}}  
        </div>
    </div>
