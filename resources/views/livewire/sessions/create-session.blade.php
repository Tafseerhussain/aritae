            ...
            <form method="POST" wire:submit.prevent="submitSession">
                ...
                <div class="row my-3">
                    <div class="col-12 d-flex justify-content-end">
                        <button type="submit" class="btn btn-dark">{{__('Continue')}}</button>
                    </div>
                </div>
            </form>
        </div>

        <div class="d-none d-xl-block col-xl-3 feature-guide">
            <div class="card w-100 mt-5 p-3">
                <h4 class="fw-bold">You can create your personalized session plan</h4>
                <p>
                    <i class="bi bi-check-circle-fill me-3"></i>
                    It's very easy, as we will guide you step by step.
                </p>
                <p>
                    <i class="bi bi-check-circle-fill me-3"></i>
                    Set your goals and availability.
                </p>
                <p>
                    <i class="bi bi-check-circle-fill me-3"></i>
                    With this data we will generate a plan.
                </p>
                <p>
                    <i class="bi bi-check-circle-fill me-3"></i>
                    You'll ss your progress.
                </p>
            </div>
        </div>
    </div>
