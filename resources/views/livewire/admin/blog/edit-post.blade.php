        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-lg-6">
                    ...
                    <div id="more-imgs-container" wire:ignore>
                        @if($more_img_urls)
                        @foreach($more_img_urls as $index => $img_url)
                        <div class="img-container">
                            <img src="/{{$img_url}}">
                            <i class="bi bi-x close-btn" data-id="{{$index}}" onclick="removeImage(event)"></i>
                        </div>
                        @endforeach
                        @endif
                    </div>
            ...
            <div class="row mt-3">
                <div class="col-12 d-flex justify-content-end">
                    <button class="btn btn-theme" wire:click="editPost">Edit Post</button>
                </div>
            </div>
        </div>
    </div>
