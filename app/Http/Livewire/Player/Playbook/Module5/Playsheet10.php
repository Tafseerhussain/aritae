...
class Playsheet10 extends Component
{
    public $playbook_id;
    ...
    public function mount($playbook_id){
        ...
        if($this->playbook->response){
            ...
            if(isset($response['module5']) && isset($response['module5']['playsheet'.$this->playsheet])){
                $this->area = $response['module5']['playsheet'.$this->playsheet]['area'];
                $this->date = $response['module5']['playsheet'.$this->playsheet]['date'];
                $this->action1 = $response['module5']['playsheet'.$this->playsheet]['action1'];
                $this->action2 = $response['module5']['playsheet'.$this->playsheet]['action2'];
                $this->action3 = $response['module5']['playsheet'.$this->playsheet]['action3'];
                $this->obstacle1 = $response['module5']['playsheet'.$this->playsheet]['obstacle1'];
                $this->obstacle2 = $response['module5']['playsheet'.$this->playsheet]['obstacle2'];
                $this->obstacle3 = $response['module5']['playsheet'.$this->playsheet]['obstacle3'];
                $this->solution1 = $response['module5']['playsheet'.$this->playsheet]['solution1'];
                $this->solution2 = $response['module5']['playsheet'.$this->playsheet]['solution2'];
                $this->solution3 = $response['module5']['playsheet'.$this->playsheet]['solution3'];
                $this->goal = $response['module5']['playsheet'.$this->playsheet]['goal'];
                $this->reward = $response['module5']['playsheet'.$this->playsheet]['reward'];
            }
        }
    }
    ...
    {
        return view('livewire.player.playbook.module5.playsheet10');
    }
}
